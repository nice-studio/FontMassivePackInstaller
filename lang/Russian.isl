...
; *** Application titles
SetupAppTitle=Установка — FontMassive Pack
SetupWindowTitle=Установка — FontMassive Pack
UninstallAppTitle=Деинсталляция — FontMassive Pack
UninstallAppFullTitle=Деинсталляция — FontMassive Pack
...
ShutdownBlockReasonInstallingApp=Установка FontMassive Pack.
ShutdownBlockReasonUninstallingApp=Деинсталляция FontMassive Pack.
...
HintLabel1_0=Перейти в репозиторий сборки
HintLabel1_1=инсталляционного пакета на GitHub
HintLabel2_0=Перейти к записи на Demiart Forum
HintLabel3_0=Посетить сайт разработчика
CaptionLabel1=Сборка пакета
